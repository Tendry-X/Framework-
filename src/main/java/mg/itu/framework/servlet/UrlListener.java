...
/**
 * SPRINT 6 : Injection automatique des arguments
 * 
 * Les méthodes peuvent maintenant avoir des paramètres qui seront
 * automatiquement récupérés depuis request.getParameter()
 * 
...
public class UrlListener extends HttpServlet {
    ...
    public void init() throws ServletException {
        try {
            ...
            System.out.println("=== Sprint 6 : URLs mappées ===");
    ...
    protected void service(HttpServletRequest req, HttpServletResponse res)
        ...
        if (matchResult == null) {
            ...
            out.println("<p><em>Sprint 6 - 15 novembre 2024</em></p>");
            return;
        }
        ...
        try {
            ...
            // SPRINT 6 : Préparer les arguments de la méthode
            Parameter[] parameters = method.getParameters();
            Object[] args = new Object[parameters.length];
            
            for (int i = 0; i < parameters.length; i++) {
                Parameter param = parameters[i];
                String paramName = param.getName(); // Par défaut : arg0, arg1...
    ...
    /**
     * SPRINT 6 : Valeurs par défaut selon le type
     */
